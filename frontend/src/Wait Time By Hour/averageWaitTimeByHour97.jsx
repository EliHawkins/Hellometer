...
const AverageWaitTimeByHourChart97 = () => {
  const [averageWaitTimeByHour, setAverageWaitTimeByHour] = useState({});
  const [chartInstance, setChartInstance] = useState(null);

  useEffect(() => {
    fetch('http://127.0.0.1:5000/store97/average-wait-time-by-hour')
  ...
  return (
    <div>
      <h2>Average Wait Time by Hour of the Day Chart for Store 97</h2>
      <canvas id="averageWaitTimeByHourChart" width="400" height="400"></canvas>
    </div>
  );
};

export default AverageWaitTimeByHourChart97;
