...
const AverageWaitTimeByHourChart27 = () => {
  const [averageWaitTimeByHour, setAverageWaitTimeByHour] = useState({});
  const [chartInstance, setChartInstance] = useState(null);

  useEffect(() => {
    fetch('http://127.0.0.1:5000/store27/average-wait-time-by-hour')
  ...
  return (
    <div>
      <h2>Average Wait Time by Hour of the Day Chart for Store 27</h2>
      <canvas id="averageWaitTimeByHourChart" width="400" height="400"></canvas>
    </div>
  );
};

export default AverageWaitTimeByHourChart27;
