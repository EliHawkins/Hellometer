...
const OrderPaymentTimesChart97 = () => {
  const [stats, setStats] = useState({});

  useEffect(() => {
    fetch('http://127.0.0.1:5000/store97/order-payment-times')
  ...
  return (
    <div>
      <h2>Order and Payment Times Statistics for Store 97</h2>
      {stats.order_stats && (
      <ul>
...
export default OrderPaymentTimesChart97;
