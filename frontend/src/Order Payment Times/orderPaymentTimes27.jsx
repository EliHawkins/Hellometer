...
const OrderPaymentTimesChart27 = () => {
  const [stats, setStats] = useState({});

  useEffect(() => {
    fetch('http://127.0.0.1:5000/store27/order-payment-times')
  ...
  return (
    <div>
      <h2>Order and Payment Times Statistics for Store 27</h2>
      {stats.order_stats && (
        <ul>
...
export default OrderPaymentTimesChart27;
