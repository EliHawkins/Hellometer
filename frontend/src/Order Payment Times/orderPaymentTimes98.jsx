...
const OrderPaymentTimesStats98 = () => {
  const [stats, setStats] = useState({});

  useEffect(() => {
    fetch('http://127.0.0.1:5000/store98/order-payment-times')
  ...
  return (
    <div>
      <h2>Order and Payment Times Statistics for Store 98</h2>
      {stats.order_stats && (
      <ul>
...
export default OrderPaymentTimesStats98;
