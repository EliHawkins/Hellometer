...
const AveragePaymentTimeByHourChart97 = () => {
  const [averagePaymentTimeByHour, setAveragePaymentTimeByHour] = useState({});
  const [chartInstance, setChartInstance] = useState(null);

  useEffect(() => {
    fetch('http://127.0.0.1:5000/store97/average-payment-time-by-hour')
  ...
  return (
    <div>
      <h2>Average Payment Time by Hour of the Day Chart for Store 97</h2>
      <canvas id="averagePaymentTimeByHourChart" width="400" height="400"></canvas>
    </div>
  );
};

export default AveragePaymentTimeByHourChart97;
